...
// Função que exibe o valor 1 ou 2 dependendo do que fez no botaopress
void exibirHex(uint8_t botao)
{
  if (botao == 1) {
    escreverSegmentos(0); // Mostra 1
  } else if (botao == 2) {
    escreverSegmentos(1); // Mostra 2
  }
}
int main(void)
{
